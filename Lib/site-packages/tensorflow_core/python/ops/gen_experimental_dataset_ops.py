...
def experimental_rebatch_dataset(input_dataset, num_workers, output_types, output_shapes, use_fallback=True, name=None):
...
def ExperimentalRebatchDataset(input_dataset, num_workers, output_types, output_shapes, use_fallback=True, name=None):
  return experimental_rebatch_dataset(input_dataset=input_dataset, num_workers=num_workers, output_types=output_types, output_shapes=output_shapes, use_fallback=use_fallback, name=name)
...
def experimental_rebatch_dataset_eager_fallback(input_dataset, num_workers, output_types, output_shapes, use_fallback=True, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def rebatch_dataset(input_dataset, num_workers, output_types, output_shapes, use_fallback=True, name=None):
  r"""Creates a dataset that changes the batch size.
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        num_workers, "output_types", output_types, "output_shapes",
  ...
  _, _, _op = _op_def_lib._apply_op_helper(
        "RebatchDataset", input_dataset=input_dataset,
                          num_workers=num_workers, output_types=output_types,
                          output_shapes=output_shapes,
                          use_fallback=use_fallback, name=name)
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
...
def RebatchDataset(input_dataset, num_workers, output_types, output_shapes, use_fallback=True, name=None):
  return rebatch_dataset(input_dataset=input_dataset, num_workers=num_workers, output_types=output_types, output_shapes=output_shapes, use_fallback=use_fallback, name=name)
...
def rebatch_dataset_eager_fallback(input_dataset, num_workers, output_types, output_shapes, use_fallback=True, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
